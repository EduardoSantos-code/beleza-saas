  ...
  return (
    <main className="min-h-screen bg-zinc-50 px-4 py-8">
      <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        {/* Título e Botão Hamburger alinhados no topo para celular */}
          ...
          >
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              {isMenuOpen ? (
                ...
                /* Ícone de Hamburger quando fechado */
        ...
        <div className="flex w-full flex-col gap-4 lg:w-auto lg:items-end">
          ...
          {/* Menu Dropdown (Oculto no celular se isMenuOpen for false, visível no desktop sempre) */}
          <div
            className={`${isMenuOpen ? "flex" : "hidden"
              } w-full flex-col gap-2 lg:flex lg:w-auto lg:flex-row lg:flex-wrap lg:items-center`}
          >
            <a href={`/admin/${slug}/billing`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Assinatura</a>
            <a href={`/admin/${slug}/metrics`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Métricas</a>
            <a href={`/admin/${slug}/services`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Serviços</a>
            <a href={`/admin/${slug}/professionals`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Profissionais</a>
            <a href={`/admin/${slug}/hours`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Horários</a>
            <a href={`/admin/${slug}/blocks`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Bloqueios</a>
            <a href={`/admin/${slug}/whatsapp`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">WhatsApp</a>
            <a href={`/admin/${slug}/inbox`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Inbox</a>
            <a href={`/admin/${slug}/branding`} className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-50">Branding</a>
