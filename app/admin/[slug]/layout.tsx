...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-zinc-50 dark:bg-zinc-950 md:flex-row">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 transform flex-col border-r border-zinc-200 bg-white transition-transform duration-300 ease-in-out dark:border-zinc-800 dark:bg-zinc-900 md:static md:flex md:translate-x-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        ...
        {/* Aumentei o pb-12 para pb-20 para dar uma folga extra no mobile */}
        <div className="border-t border-zinc-200 p-4 pb-20 lg:pb-4 dark:border-zinc-800 space-y-4">
